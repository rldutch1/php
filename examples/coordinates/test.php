<?php
//https://github.com/prairiewest/PHPconvertDMSToDecimal/blob/master/test.php
...
$test_cases = array(
    ...
    "N144.35.26"," 144.35.26s","-144 35 26","144º 35' 26\"w","45°43'51''N","009°44'23''E"," 50° 5' N", " -8°56'O"
);
foreach ($test_cases as $t) {
	echo $t . "\t=>\t";
	echo convertDMSToDecimal($t) . "\n";
}
?>
