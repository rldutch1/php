...
$serverName = "phx04134.bhs.bannerhealth.com";

try {
	$handler = new PDO("sqlsrv:server=$serverName; Database=Canned_mPage", "mpage", "mpage");
...
$query0 = $handler->query('select * from mpage_settings');
