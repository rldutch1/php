...
try { <br />
	\$handler = new PDO('mysql:host=localhost;dbname=TheDatabaseName;charset=utf8', 'TheUsername', 'ThePassword!'); //Setting the handler. See next line if this line fails. <br />
