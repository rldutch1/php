...
try {
   ...
   $static_content_url=$handler->query("SELECT DISTINCT(EUC_EnvPkg.PkgNum) AS Package_Num, EUC_EnvPkg.pkgversion AS Version, EUC_Env.EnvName AS Domain, EUC_EnvPkg.InstallDate, EUC_PkgDefinition.PkgName, EUC_PkgType.PkgTypeDescription
...
$txt = "";
	foreach($static_content_url as $r){
...
//  $static_content_url=$handler->query("SELECT DISTINCT(EUC_EnvPkg.PkgNum) AS Package_Num, EUC_EnvPkg.pkgversion AS Version FROM EUC_EnvPkg;");
