...
<head>
	...
	<script src='js/jquery-1.9.1.js' type='text/javascript' charset='utf-8'></script> <!-- Load the js before you use it. -->
	<script src='js/tooltiptest1.js' type='text/javascript' charset='utf-8'></script> <!-- Being used. -->
	<link rel='stylesheet' type='text/css' href='css/tooltiptest1.css'>
</head>
<title></title>
<body>
<br />
<div><a href='tooltiptest2.php'>Toggle</a></div>
<table border='1' align='left'>
<caption class='thetip3'><b>Formatted Hover Data Displayed From a Hidden DIV.<br />Separate .js and .css</b></caption>
<tr>
	<th>Header1</th>
	<th>Header2</th>
	<th>Header3</th>
...
<tr>
	...
	<div id='tooltip02'>
		...
		2. Proceed with clearance & notify anesthesia.
	</div>
	<div id='tooltip03'>
		<table border='1'><caption>".$fromphp."</caption>
